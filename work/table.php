...
$tbl_course="CREATE TABLE IF NOT EXISTS std_course(
    s_id INT (11) NOT NULL,
    det VARCHAR (20) NOT NULL,
    course VARCHAR (20) NOT NULL,
    FOREIGN KEY (s_id) REFERENCES std_info (s_id)
...
$result2=mysqli_query($myconn,$tbl_course);
if($result1===TRUE)
{ 
...
$tbl_semester="CREATE TABLE IF NOT EXISTS std_semester(
    s_id INT (11) NOT NULL,
    det VARCHAR (20) NOT NULL,
    course VARCHAR (20) NOT NULL,
    FOREIGN KEY (s_id) REFERENCES std_info (s_id)
    ...
    $result2=mysqli_query($myconn,$tbl_semester);
    if($result1===TRUE)
    { 
    echo"student semester  tabel created  ";
    }
    else{
    echo"student semester tabel not  created  ";
    }
